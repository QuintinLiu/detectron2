...
from detectron2.data.dataset_mapper import MyDatasetMapper
...
class MyTrainer(DefaultTrainer):
    ...
    "SimpleMyTrainer", or write your own training loop. You can use
    ...
    def build_train_loader(cls, cfg):
        my_mapper = MyDatasetMapper(cfg, True)
        return build_detection_train_loader(cfg, my_mapper)
